...
# 고정 단어 목록 (학습 및 회상 세션에서 공통 사용)
# 긍정 5개, 부정 5개, 중립 5개 = 15개
# 모두 2음절, 홍영지 등(2016) 정서단어 목록 기반
# 선정 기준: 범주 내 정서가 극단값, 각성가 유사 범위, 구체성 통제
FIXED_WORD_LIST = [
    # 긍정 (valence > 7.0)
    {"word": "기쁨", "valence": 8.24, "arousal": 5.82, "concreteness": 2.87, "category": "positive"},
    {"word": "사랑", "valence": 8.17, "arousal": 4.54, "concreteness": 2.97, "category": "positive"},
    {"word": "감사", "valence": 7.96, "arousal": 3.36, "concreteness": 3.13, "category": "positive"},
    {"word": "희망", "valence": 7.28, "arousal": 5.33, "concreteness": 2.45, "category": "positive"},
    {"word": "행운", "valence": 7.74, "arousal": 3.83, "concreteness": 2.61, "category": "positive"},
    # 부정 (valence < 3.0)
    {"word": "고통", "valence": 2.42, "arousal": 6.83, "concreteness": 3.42, "category": "negative"},
    {"word": "슬픔", "valence": 2.81, "arousal": 5.46, "concreteness": 4.18, "category": "negative"},
    {"word": "분노", "valence": 2.84, "arousal": 6.61, "concreteness": 3.25, "category": "negative"},
    {"word": "공포", "valence": 2.84, "arousal": 7.19, "concreteness": 2.98, "category": "negative"},
    {"word": "절망", "valence": 2.11, "arousal": 6.21, "concreteness": 2.73, "category": "negative"},
    # 중립 (valence 4.5~6.0, 구체 사물 명사)
    {"word": "책상", "valence": 5.55, "arousal": 3.80, "concreteness": 8.61, "category": "neutral"},
    {"word": "의자", "valence": 5.46, "arousal": 3.55, "concreteness": 8.30, "category": "neutral"},
    {"word": "시계", "valence": 5.62, "arousal": 3.87, "concreteness": 8.53, "category": "neutral"},
    {"word": "우산", "valence": 5.10, "arousal": 3.70, "concreteness": 8.66, "category": "neutral"},
    {"word": "열쇠", "valence": 5.74, "arousal": 4.00, "concreteness": 8.59, "category": "neutral"},
]

# 채점용 고정 단어 집합
FIXED_WORD_SET = {w["word"] for w in FIXED_WORD_LIST}


def get_fixed_word_list(randomize: bool = True) -> 'List[WordStimulus]':
    """고정 단어 목록을 WordStimulus 리스트로 반환

    Args:
        randomize: True면 무선화된 순서, False면 고정 순서
    """
    words = [
        WordStimulus(
            word=w["word"],
